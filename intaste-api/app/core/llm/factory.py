...
class LLMClientFactory:
    ...
    def create_from_settings(cls, settings: Any) -> LLMClient:
        ...
        """
        client_name = settings.intaste_llm_provider
        config = {
            "base_url": settings.ollama_base_url,
            "model": settings.intaste_default_model,
            "timeout_ms": settings.intaste_llm_timeout_ms,
            "temperature": settings.intaste_llm_temperature,
            "top_p": settings.intaste_llm_top_p,
        }
