...
import os
os.environ.setdefault("INTASTE_API_TOKEN", "test-token-32-characters-long-secure")
...
def test_settings() -> Settings:
    ...
    return Settings(
        intaste_api_token="test-token-32-characters-long-secure",
        fess_base_url="http://test-fess:8080",
        ollama_base_url="http://test-ollama:11434",
        req_timeout_ms=5000,
        intaste_default_model="test-model",
...
def auth_headers(test_settings: Settings) -> dict[str, str]:
    ...
    return {
        "X-Intaste-Token": test_settings.intaste_api_token,
